...
export default function Home(){
 ...
 <div className="desktop-heading"><p>A few things I’m working on.</p><h1>luciano<br/>pinilla<span>®</span></h1><div className="identity-links"><a href="https://x.com/foezart" target="_blank" rel="noopener noreferrer">@foezart ↗</a><span>Independent work, ongoing.</span></div></div>
 <div className="workspace">
 <Window id="work"><div className="work-toolbar"><span><span className="tiny-folder">▰</span> Projects / Fomo Campus</span><span>01</span></div><a href="https://fomo-campus-wars-luchi.luciano589188.chatgpt.site/" target="_blank" rel="noopener noreferrer" className="project-image"><img src="/images/fomo-village.jpg" alt="The Greek village from the Fomo Campus website"/><span className="project-image-label">fomo<span>campus</span></span><span className="image-arrow"><ArrowUpRight size={24}/></span></a><div className="project-copy"><div className="eyebrow">FEATURED PROJECT · 2026</div><h2>From a campus idea<br/>to a working website.</h2><p>The Fomo Campus experience: Greek Wars, chapter registration, and a village you can fly into.</p><div className="project-bottom"><span className="project-tags">Web design <b>·</b> Development</span><Out href="https://github.com/ouchip/fomo-campus">View source</Out></div></div></Window>
 <Window id="about"><div className="note-toolbar"><span>All notes</span><span>1 note</span></div><div className="note-body"><p className="note-date">A little introduction</p><h2>Hey, I’m Luciano.</h2><p>I like turning ideas into things you can actually use.</p><p>Right now, that means building Fomo Campus—and making this corner of the internet my own.</p><button className="handwritten" onClick={()=>show('contact')}>Let’s make something. <ArrowUpRight size={20}/></button></div></Window>
 <Window id="activity"><div className="activity-body"><div className="activity-heading"><div><span className="eyebrow">BUILDING IN PUBLIC</span><h2>A little more green.</h2></div><GitBranch size={26}/></div><Activity/><Out className="activity-link" href="https://github.com/ouchip">github.com/ouchip</Out></div></Window>
 <Window id="contact"><div className="contact-body"><MessageCircle size={32}/><span className="eyebrow">GET IN TOUCH</span><h2>Good things start<br/>with a conversation.</h2><p>Find me on X. See what I’m building on GitHub.</p><Out className="contact-link" href="https://x.com/foezart">@foezart</Out><Out className="contact-link secondary-link" href="https://github.com/ouchip">GitHub / ouchip</Out></div></Window>
...
function Activity(){return <div className="activity-loading">Connecting to GitHub…</div>}
