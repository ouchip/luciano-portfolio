...
export default function Home(){
 ...
 <Window open={open} front={front} expanded={expanded} setFront={setFront} setOpen={setOpen} setExpanded={setExpanded} id="contact"><div className="contact-body"><h2>Let’s talk.</h2><p>Send a note or reach out on <img className="social-mark inline-x" src="/icons/x.svg" alt="X"/>.</p><EmailContact email="luchi@lucianopinilla.com"/><div className="contact-socials"><Out className="contact-link" href="https://x.com/foezart"><span><img className="social-mark" src="/icons/x.svg" alt="X"/>@foezart</span></Out><Out className="contact-link" href="https://www.linkedin.com/in/luciano-pinilla-134668381/"><span><img className="social-mark" src="/icons/linkedin.svg" alt=""/>LinkedIn</span></Out></div></div></Window>
